                    ...
                    <form method="post" action="{{ route('emargement.create') }}" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="formcontrol">Arriverr <input type="radio" name="emarge" value="arrived" checked></div>
                                        <div class="formcontrol">Depart : <input type="radio" name="emarge" value="leaved"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
